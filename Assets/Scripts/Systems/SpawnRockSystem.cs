...
public partial struct SpawnRockSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        var arrayBuilder = spawnPointsBuilder.Allocate(ref spawnPoints.BlobArray, level.RocksToSpawn);
        ...
        ecb.SetComponent(levelEntity, new BugSpawnPoints { AssetArray = blobAsset });
